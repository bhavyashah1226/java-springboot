...
public class Product_setName_5d23a892d9_Test {
    ...
    public void testSetName_StringWithMaxLength() {
        String maxLenString = new String(new char[2147483647]).replace("\0", "a");
    ...
    public void testSetName_StringExceedingMaxLength() {
        String exceedingMaxLenString = new String(new char[2147483647]).replace("\0", "a") + "a";
        assertThrows(OutOfMemoryError.class, () -> product.setName(exceedingMaxLenString));
    }
