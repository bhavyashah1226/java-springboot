...
public class Product_setName_5d23a892d9_Test {
    ...
    @Test
    public void testSetName_StringWithMaximumLength() {
        // TODO: Set the maximum permissible length
        String maxLenString = new String(new char[255]).replace('\0', 'a');
        product.setName(maxLenString);
        assertEquals(maxLenString, product.getName());
    }

    @Test
    public void testSetName_StringExceedingMaximumLength() {
        // TODO: Set the maximum permissible length + 1
        String exceedingMaxLenString = new String(new char[256]).replace('\0', 'a');
        assertThrows(IllegalArgumentException.class, () -> product.setName(exceedingMaxLenString));
    }
    ...
    @Test
    public void testSetName_TrimsLeadingAndTrailingSpaces() {
        product.setName(" abc ");
        assertEquals("abc", product.getName().trim());
    }
}
