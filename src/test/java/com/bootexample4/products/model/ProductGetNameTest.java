...
roost_feedback [11/13/2024, 3:56:09 AM]:add more test cases
*/
...
public class ProductGetNameTest {
	...
	@Test
	@Tag("valid")
	public void validateNameWithSpaces() {
		// Arrange
		Product product = new Product();
	...
	public void validateNameWithSpecialCharacters() {
     ...
     public void validateLongName() {
        // Arrange
        Product product = new Product();
		String expectedProductName = "ThisIsAVeryLongNameForAProductJustToTestTheBoundaryCondition";
        product.setName(expectedProductName);
        // Act
        String actualProductName = product.getName();
        // Assert
