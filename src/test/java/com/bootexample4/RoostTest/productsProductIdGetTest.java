...
public class productsProductIdGetTest {
    ...
    public void productsProductIdGet_Test() {  
        ...
        // Read CSV file  
        try (BufferedReader reader = new BufferedReader(new FileReader("src" + File.separator + "test" + File.separator + "java" + File.separator + "com" + File.separator + "bootexample4" + File.separator + "RoostTest" + File.separator + "products_productIdGetTest.csv"))) {  
